  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Match Prediction', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: Colors.white)),
        actions: [
          IconButton(
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.outfit(fontSize: 11, color: Colors.white24, height: 1.5),
            ),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(shortName, style: GoogleFonts.outfit(fontSize: 14, color: Colors.white70)),
      ],
    );
  }
}
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(full, style: GoogleFonts.outfit(fontSize: 11, color: Colors.white38)),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(value, style: GoogleFonts.outfit(fontSize: 13, color: Colors.white, fontWeight: FontWeight.w600))),
        ],
      ),
    );
  }
