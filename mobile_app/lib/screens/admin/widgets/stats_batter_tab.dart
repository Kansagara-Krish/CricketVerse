...
class StatsBatterTab extends StatelessWidget {
  final List<Player> players;

  const StatsBatterTab({super.key, required this.players});
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            '${p.runsScored}',
                            style: GoogleFonts.plusJakartaSans(fontSize: 16, fontWeight: FontWeight.w900, color: AppTheme.primaryBlue),
                          ),
                          Text(
                            'runs',
